package com.wanris.business.common.ui.widget.flowLayout;
...
import com.wanris.business.common.utils.DensityHelper;
import com.wanris.library.resource.DimenUtil;
    ...
    private void changeAdapter() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tagView.getLayoutParams() != null) {
                ...
                lp.setMargins(DensityHelper.dip2px(5),
                        DensityHelper.dip2px(5),
                        DensityHelper.dip2px(5),
                        DensityHelper.dip2px(5));
